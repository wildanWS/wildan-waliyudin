...
#         grades = input("enter the grades of student " + str(i+1) + " ( comma-sparated): ")
#         students.append(
#             {
#             "nama" : name,
#             "nilai" : grades,
#             "rataRata_nilai" : totalgrades(grades)
#             }
#         )

def my_function(*kids):
    print("saya akan memesan " + kids[3])

my_function("jus", "gorengan", "baso", "cilok")

def my_function(**kid):
    print("his last name is" + kid["lname"])

    my_function(fname = "tobias", lname = "solihin")
